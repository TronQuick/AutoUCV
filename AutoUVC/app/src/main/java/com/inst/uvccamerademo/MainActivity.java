...
import com.inst.uvccamerademo.encoder.MediaAudioEncoder;
import com.inst.uvccamerademo.encoder.MediaEncoder;
import com.inst.uvccamerademo.encoder.MediaMuxerWrapper;
import com.inst.uvccamerademo.encoder.MediaSurfaceEncoder;
...
//		Toast.makeText(MainActivity.this, "DeviceCount" + usbDeviceCount, Toast.LENGTH_SHORT).show();
